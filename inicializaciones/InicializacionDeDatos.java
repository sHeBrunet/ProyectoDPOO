...
public class InicializacionDeDatos {
	...
	public static void inicializarDiscosDuros(TiendaDeComputadoras tienda) {
		...
		discosDuros.add(new DiscoDuro(8, "DD12346", "Samsung", "T5", 64.99f, false, 4, "SATA"));
		discosDuros.add(new DiscoDuro(12, "DD12347", "WD", "My Passport", 64.99f, false, 2, "SATA-3"));
		discosDuros.add(new DiscoDuro(9, "DD12348", "Seagate", "Backup Plus", 65.99f, false, 4, "SATA-2"));
		discosDuros.add(new DiscoDuro(11, "DD12349", "Toshiba", "Canvio Advance", 49.99f, false, 2, "SATA"));
		...
		discosDuros.add(new DiscoDuro(12, "DD12352", "Seagate", "Expansion", 63.99f, false, 4, "SATA"));
		discosDuros.add(new DiscoDuro(9, "DD12353", "Toshiba", "N300", 56.99f, false, 6, "SATA"));
		discosDuros.add(new DiscoDuro(11, "DD12354", "Samsung", "970 EVO Plus", 84.99f, false, 8, "SATA-3"));
		ArrayList<ComponenteOrdenador> c = new ArrayList<ComponenteOrdenador>();
	...
	public static void inicializarMicroprocesador(TiendaDeComputadoras tienda) {
		...
		microprocesadores.add(new Microprocesador(5, "MP12345", "AMD", "Ryzen 5 5600X", 56.99f, "AM4", 3.5f));
		microprocesadores.add(new Microprocesador(4, "MP12346", "Intel", "Core i5-12600K", 73.99f, "LGA 1700", 3.5f));
		microprocesadores.add(new Microprocesador(6, "MP12347", "AMD", "Ryzen 7 5800X3D", 59.99f, "AM4", 3.5f));
		microprocesadores.add(new Microprocesador(7, "MP12348", "Intel", "Core i7-13700K", 76.99f, "LGA 1700", 3.5f));
		microprocesadores.add(new Microprocesador(5, "MP12349", "AMD", "Ryzen 9 5900X", 62.99f, "AM4", 3.5f));
		microprocesadores.add(new Microprocesador(4, "MP12350", "Intel", "Core i9-13900K", 81.99f, "LGA 1700", 4f));
		microprocesadores.add(new Microprocesador(6, "MP12351", "AMD", "Ryzen 9 7900X", 73.99f, "AM5", 4.0f));
		microprocesadores.add(new Microprocesador(7, "MP12352", "Intel", "Core i3-12100F", 68.99f, "LGA 1700", 2f));
		microprocesadores.add(new Microprocesador(5, "MP12353", "AMD", "Ryzen 5 5600X", 58.99f, "AM4", 4f));
		microprocesadores.add(new Microprocesador(4, "MP12354", "Intel", "Core i5-12600K", 71.99f, "LGA 1700", 2f));
		ArrayList<ComponenteOrdenador> c = new ArrayList<ComponenteOrdenador>();
	...
	public static void inicializarMemoriasRAM(TiendaDeComputadoras tienda) {
		...
		memoriasRAM.add(new MemoriaRam(20, "MR12345", "Crucial", "Ballistix Sport LT DDR4", 53.99f,  false, 16, "DDR-4"));
		memoriasRAM.add(new MemoriaRam(15, "MR12346", "Corsair", "Vengeance LPX DDR4", 69.99f, false, 16, "DDR-4"));
		memoriasRAM.add(new MemoriaRam(18, "MR12347", "G.Skill", "Trident Z Neo DDR4", 70.99f,  false,32, "DDR-4"));
		memoriasRAM.add(new MemoriaRam(22, "MR12348", "Kingston", "Kingston ValueRAM DDR4", 55.99f, false, 8, "DDR-4"));
		memoriasRAM.add(new MemoriaRam(25, "MR12349", "Crucial", "Ballistix Max DDR4", 61.99f,  false,32, "DDR-4"));
		memoriasRAM.add(new MemoriaRam(20, "MR12350", "Corsair", "Dominator Platinum RGB DDR4", 77.99f, false, 32, "DDR-4"));
		memoriasRAM.add(new MemoriaRam(15, "MR12351", "G.Skill", "Trident Z5 DDR5", 78.99f,  false, 32, "DDR-5"));
		memoriasRAM.add(new MemoriaRam(18, "MR12352", "Kingston", "Kingston Fury Renegade DDR5", 65.99f,  false, 16, "DDR-5"));
		memoriasRAM.add(new MemoriaRam(22, "MR12353", "Crucial", "Ballistix 5600 MHz DDR5", 69.99f,  false, 32, "DDR-5"));
		memoriasRAM.add(new MemoriaRam(25, "MR12354", "Corsair", "Vengeance RGB Pro DDR4", 74.99f,  false, 32, "DDR-4"));
		ArrayList<ComponenteOrdenador> c = new ArrayList<ComponenteOrdenador>();
	...
	public static void inicializarTarjetasVideo(TiendaDeComputadoras tienda) {
		...
		tarjetasVideo.add(new TarjetaDeVideo(5, "TV12345", "AMD", "Radeon RX 6600", 72.99f, "Aire"));
		tarjetasVideo.add(new TarjetaDeVideo(4, "TV12346", "Gigabyte", "GeForce RTX 3070 Eagle OC", 87.99f, "Líquido"));
		tarjetasVideo.add(new TarjetaDeVideo(6, "TV12347", "AMD", "Radeon RX 6700 XT", 75.99f, "Aire"));
		tarjetasVideo.add(new TarjetaDeVideo(7, "TV12348", "MSI", "GeForce RTX 3070 Gaming X Trio", 101.99f, "Mixto"));
		tarjetasVideo.add(new TarjetaDeVideo(5, "TV12349", "AMD", "Radeon RX 6800 XT", 78.99f, "Aire"));
		tarjetasVideo.add(new TarjetaDeVideo(4, "TV12350", "Gigabyte", "GeForce RTX 3080 Gaming OC", 90.99f, "Líquido"));
		tarjetasVideo.add(new TarjetaDeVideo(6, "TV12351", "AMD", "Radeon RX 6900 XT", 81.99f, "Aire"));
		tarjetasVideo.add(new TarjetaDeVideo(7, "TV12352", "ASUS", "GeForce RTX 3080 TUF Gaming OC", 98.99f, "Líquido"));
		tarjetasVideo.add(new TarjetaDeVideo(5, "TV12353", "MSI", "GeForce GTX 1660 Super Ventus XS OC", 80.99f, "Aire"));
		tarjetasVideo.add(new TarjetaDeVideo(4, "TV12354", "NVIDIA", "GeForce RTX 4090", 112.99f, "Mixto"));
		ArrayList<ComponenteOrdenador> c = new ArrayList<ComponenteOrdenador>();
	...
	public static ArrayList<String> memoriasKingston() {
		...
		memoriasKingston.add("Kingston ValueRAM DDR4");
		memoriasKingston.add("Kingston Fury Renegade DDR5");
		memoriasKingston.add("Kingston Server Premier DDR5");		
		memoriasKingston.add("Kingston SO-DIMM DDR5");
	...
	public static ArrayList<String> memoriasHyperX() {
		...
		memoriasHyperX.add("HyperX Predator DDR5");
